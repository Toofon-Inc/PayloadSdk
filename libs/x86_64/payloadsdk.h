...
const char *payload_uart_port = (char*)"/dev/ttyUSB0";
const int payload_uart_baud = 115200;
const char *udp_ip_target = (char*)"192.168.12.240";   // This is an ip address of the payload
const int udp_port_target = 14566;                     // Do not change
